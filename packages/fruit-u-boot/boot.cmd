...
setenv bootargs_default "8250.nr_uarts=1 console=ttyAMA0,115200 console=tty1 noquite cgroup_enable=cpuset,memory panic=5 loglevel=7 dwc_otg.lpm_enable=0 root=${root_dev} rootfstype=ext4 overlaytmpfs"
