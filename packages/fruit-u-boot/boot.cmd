...
setenv bootargs "8250.nr_uarts=1 console=ttyAMA0,115200 console=tty1 cgroup_enable=cpuset noquite panic=5 loglevel=7 dwc_otg.lpm_enable=0 root=${root_dev} rootfstype=ext4";
env export -t 0x100 bootargs;
if fatload mmc 0:1 0x109 cmdline.txt;
then
	env import -t 0x100;
	setenv bootargs "${bootargs} 8250.nr_uarts=1 cgroup_enable=cpuset panic=5 loglevel=7";
